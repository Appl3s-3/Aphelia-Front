            ...
            <div id="manage-menu" v-if="state.showManageMenu">
                ...
                <div class="manage-confirm-menu manage-delete-item-menu">
                    ...
                    <div class="manage-confirm-menu-options">
                        <input class="manage-menu-grey-button" type="button" name="" value="Back" @click="">
                        <input class="manage-menu-deny-button" type="button" name="" value="Delete" @click="">
                    </div>
                </div>
                <div class="manage-confirm-menu manage-delete-archetype-menu">
                    ...
                    <div class="manage-confirm-menu-options">
                        <input class="manage-menu-grey-button" type="button" name="" value="Back" @click="">
                        <input class="manage-menu-deny-button" type="button" name="" value="I understand the consequences" @click="">
                    </div>
                </div>
                <div class="manage-confirm-menu manage-delete-archetype-second-menu">
                ...
                <div class="manage-confirm-menu manage-reset-menu">
                    ...
                    <div class="manage-confirm-menu-options">
                        ...
                        <span class="manage-confirm-menu-options-exit">
                            <input class="manage-menu-deny-button" type="button" name="" value="Reset" @click="">
                            <input class="manage-menu-deny-button" type="button" name="" value="Reset and Exit" @click="">
                        </span>
                    </div>
                </div>
                <div class="manage-confirm-menu manage-save-menu">
                    ...
                    <div class="manage-confirm-menu-options">
                        <input class="manage-menu-grey-button" type="button" name="" value="Back" @click="">
                        <span class="manage-confirm-menu-options-exit">
                            <input class="manage-menu-confirm-button" type="button" name="" value="Save" @click="">
                            <input class="manage-menu-confirm-button" type="button" name="" value="Save and Exit" @click="">
                        </span>
                    </div>
                </div>
                <div class="manage-confirm-menu manage-exit-menu">
...
/***** Manage Menu Buttons */
.manage-menu-confirm-button {
    background-color: var(--aph-blue);
}

.manage-menu-deny-button {
    background-color: var(--aph-warning);
}

.manage-menu-grey-button {
